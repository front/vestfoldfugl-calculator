...
function createComponentOnReadyPrototype(win, HTMLElementPrototype, App) {
  ...
  // add componentOnReady to HTMLElement.prototype
    var orgComponentOnReady = HTMLElementPrototype.componentOnReady;
...
function createPlatformMain(namespace, Context, win, doc, resourcesUrl, hydratedCssClass, customStyle) {
  ...
  false;
  (true, customStyle) && customStyle.init();
...
function defineCustomElement(win, cmpData, opts) {
  ...
  var namespace = opts.namespace || 'VfCalc';
  if (!initCmpOnReady) {
    initCmpOnReady = true;
    var App = win[namespace] = win[namespace] || {};
    createComponentOnReadyPrototype(win, win.HTMLElement.prototype, App);
  }
